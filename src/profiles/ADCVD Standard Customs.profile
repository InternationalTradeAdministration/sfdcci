...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <custom>true</custom>
    <description>Has the edit/create permission on (Order, Customs Instructions, Harmonized, and Interested Org.) and read for all other ADCVD objects</description>
    <fieldPermissions>
