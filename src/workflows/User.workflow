<?xml version="1.0" encoding="utf-8"?><Workflow xmlns="http://soap.sforce.com/2006/04/metadata"><alerts>
        ...
        <template>Privacy_Shield_Templates/Trade_Community_PS_Welcome1</template>
    </alerts><alerts>
        <fullName>EG_New</fullName>
        <description>EG - New</description>
        <protected>false</protected>
        <recipients>
            <field>Email</field>
            <type>email</type>
        ...
        <active>true</active>
        <formula>AND(Profile.Name == 'Customer Trade Community User', IsActive == true, Contact.site__r.Name != 'Privacy Shield',  Registered_Domain__c = 'Export.gov')</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules><rules>
        ...
        <active>true</active>
        <formula>AND(Profile.Name == 'Customer Trade Community User', IsActive == true, Contact.site__r.Name != 'Privacy Shield',  Registered_Domain__c = 'Stopfakes.gov')</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules><rules>
        ...
        <active>true</active>
        <formula>AND(Profile.Name == 'Customer Trade Community User', IsActive == true, Contact.site__r.Name != 'Privacy Shield',  Registered_Domain__c = 'SelectUSA')</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules><rules>
